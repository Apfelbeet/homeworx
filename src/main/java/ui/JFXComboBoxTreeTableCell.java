...
import static ui.CellUtils.createComboBox;
 ...
 *
 * <p>By default, the JFXComboBoxTreeTableCell is rendered as a {@link Label} when not
 * being edited, and as a ComboBox when in editing mode. The ComboBox will, by
 * default, stretch to fill the entire table cell.
 *
 * <p>To create a JFXComboBoxTreeTableCell, it is necessary to provide zero or more
 ...
 * @since JavaFX 8.0
 */
public class JFXComboBoxTreeTableCell<S,T> extends TreeTableCell<S,T> {
    ...
    public static <S,T> Callback<TreeTableColumn<S,T>, TreeTableCell<S,T>> forTreeTableColumn(
            final StringConverter<T> converter,
            final ObservableList<T> items) {
        return list -> new JFXComboBoxTreeTableCell<S,T>(converter, items);
    }
    ...
    /**
     * Creates a default JFXComboBoxTreeTableCell with an empty items list.
     */
    public JFXComboBoxTreeTableCell() {
        this(FXCollections.<T>observableArrayList());
    }

    /**
     * Creates a default {@link JFXComboBoxTreeTableCell} instance with the given items
     ...
     */
    @SafeVarargs
    public JFXComboBoxTreeTableCell(T... items) {
        this(FXCollections.observableArrayList(items));
    }

    /**
     * Creates a {@link JFXComboBoxTreeTableCell} instance with the given items
     ...
     */
    @SafeVarargs
    public JFXComboBoxTreeTableCell(StringConverter<T> converter, T... items) {
     ...
     *      by the user.
     */
    public JFXComboBoxTreeTableCell(ObservableList<T> items) {
        this(null, items);
    }
     ...
     *      by the user.
     */
    public JFXComboBoxTreeTableCell(StringConverter<T> converter, ObservableList<T> items) {
