...
class CellUtils {
    ...
    static <T> void updateItem(Cell<T> cell, StringConverter<T> converter, JFXComboBox<T> comboBox) {
    ...
    static <T> JFXComboBox<T> createComboBox(final Cell<T> cell,
                                          final ObservableList<T> items,
                                          final ObjectProperty<StringConverter<T>> converter) {
        JFXComboBox<T> comboBox = new JFXComboBox<T>(items);
        comboBox.converterProperty().bind(converter);
        comboBox.setMaxWidth(Double.MAX_VALUE);
        comboBox.setFocusColor(new Color(0.3, 0.3, 0.3, 1));
